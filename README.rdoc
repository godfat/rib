...
If you don't know what is ripl, or just want to have an
overview of what does ripl-rc do, then you can use it as
a command line tool:

    ripl rc

This can be used to run rails console, too. First install
ripl-rails by `gem install ripl-rails` then run this:
...
You can anchor another object inside a ripl session. The number
